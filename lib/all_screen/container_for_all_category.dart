...
import 'category_wise_separate.dart';

class CategoryForAllContainer extends StatefulWidget {
  const CategoryForAllContainer({
    Key? key,
...
class _CategoryContainerState extends State<CategoryForAllContainer> {
  var categoryData = [];
