...
import 'package:customer_ui/all_screen/search.dart';
        ...
        for (String area in areaList) {
          if (areaName == area) {
            ...
            setState(() {
              ...
              currentUser = int.parse(_userId);
              currentWebStore = int.parse(_webStoreId);
            });
          }
        }
      }
            ...
            child: Column(children: [
              ...
              CarouselSlider.builder(
                ...
                itemBuilder: (BuildContext context, int itemIndex, int pageViewIndex) => Container(
                  ...
                  child: sliderData.isNotEmpty
                      ? Image.network(
                          imagePath + sliderData[itemIndex].photo!,
                          fit: BoxFit.cover,
                        )
                      : Center(),
                ),
                                              ...
                                              children: [
                                                Align(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                      color: categoryProducts[index].hasDiscount == true
                                                          ? Color(0xFF10AA2A)
                                                          : Color(0xFFF4F1F5),
