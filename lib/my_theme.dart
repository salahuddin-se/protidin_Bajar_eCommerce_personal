...
class MyTheme {
  ...
  static Color accent_color = Color.fromRGBO(153, 0, 255, 1);
  static Color soft_accent_color = Color.fromRGBO(230, 193, 255, 1);
  static Color splash_screen_color = Color.fromRGBO(
      153, 0, 255, 1); // if not sure , use the same color as accent color
